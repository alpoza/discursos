...
discursos_ngrams2 = bind_rows(discursos %>% rename(ngrams=word) %>% mutate(ngram_n = 1),discursos_bigrams, discursos_trigrams, discursos_n4grams)
...
```{r ngrams2 plot, message=FALSE, warning=FALSE}
